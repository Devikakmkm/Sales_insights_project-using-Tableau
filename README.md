...
1. Follow this to install mysql on your local computer
https://www.youtube.com/watch?v=WuBcTJnIuzo

2. Some analysis using different sql queries.

3. Install Tableau on your local system, which allows exporting mysql database. Online community vesrion cannot be used in this. Free trial is available for 14 days.
